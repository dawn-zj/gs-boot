package cn.com.gs.library.controller.book;

import cn.com.gs.library.util.CommonUtil;
...
import cn.com.gs.library.logger.Log4jTest;
...
public class BookController {
	...
	public ModelAndView insertBook(Book bk, Page<Book> page, ModelAndView mv){
		bookService.insertBook(bk);
		page = bookService.searchBookByPage(page, null);
		mv.addObject("page",page);
		mv.setViewName("book/bookList");
		return mv;
	}
